export const getDayFromDate = ({date, type = 'short' }: { date: string, type?: "short" | "long" | "narrow"}) => {
...
export const getMonthFromDate = ({date, type = 'short' }: { date: string, type?: "short" | "long" | "narrow"}) => {
